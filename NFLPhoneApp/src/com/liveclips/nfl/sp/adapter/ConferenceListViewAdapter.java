	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		LayoutInflater mInflater = (LayoutInflater) context
			...
			if (convertView == null) {
				...
				holder.team_1_name = (TextView)convertView.findViewById(R.id.team_1_name);
				
				holder.team_2_name = (TextView)convertView.findViewById(R.id.team_2_name);
				
				holder.team_3_name = (TextView)convertView.findViewById(R.id.team_3_name);
				
				holder.team_4_name = (TextView)convertView.findViewById(R.id.team_4_name);
